...
a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},
    oPaginate: { sFirst: "Primeira", sLast: "Última", sNext: "Próximo", sPrevious: "Anterior" }, sEmptyTable: "Nenhuma informação encontrada.", sInfo: "Exibindo de _START_ à _END_ do total de _TOTAL_ registros", sInfoEmpty: "Exibindo 0 de 0 de 0 registros", sInfoFiltered: "(Filtrado dentre _MAX_ registros no total)", sInfoPostFix: "", sDecimal: "", sThousands: ",", sLengthMenu: "Exibir _MENU_ registros por página", sLoadingRecords: "Carregando! Aguarde...", sProcessing: "Processando...", sSearch: "Buscar:", sSearchPlaceholder: "", sUrl: "", sZeroRecords: "Nenhum registro encontrado para sua busca. Tente novamente utilizando outro termo"
}, oSearch: h.extend({},
